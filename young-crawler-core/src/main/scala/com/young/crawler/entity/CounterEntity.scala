...
case class AllCounter(fetchCounter: FetchCounter, fetchOk: FetchOk, fetchError: FetchError, injectCounter: InjectCounter, parseCounter: ParseCounter, parseChildUrlCounter: ParseChildUrlCounter, indexCounter: IndexCounter) extends Counter
